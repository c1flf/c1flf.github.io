...
var translations = {
	...
	da: {
		...
		cartTitleText: "IndkÃ¸bskurv",
		checkoutText: "Bestilling",
		continueShoppingText: "FortsÃ¦tte med at handle",
		couponLabelText: "Indtast kuponkode",
		couponPlaceholderText: "Kuponkode",
		crossSellText: "TilfÃ¸j til kurv",
		crossSellTitleText: "Du kan ogsÃ¥ vÃ¦re interesseret i ...",
		dayText: "dag",
		daysText: "dage",
		edsText: "TilfÃ¸j til kurv",
		freeText: "Gratis",
		monthText: "mÃ¥ned",
		monthsText: "mÃ¥ned",
		nextChargeText: "NÃ¦ste opkrÃ¦vning:",
		onText: "d",
	...
	de: {
		...
		crossSellTitleText: "Sie kÃ¶nnten auch interessiert sein an ...",
		dayText: "Tag",
		daysText: "Tage",
		...
		monthText: "Monat",
		monthsText: "Monate",
		nextChargeText: "NÃ¤chste Abbuchung:",
		onText: "am",
		orderEmptyText: "Ihre Bestellung ist leer",
		orderTotalText: "Summe",
		removeText: "Entfernen",
		renewsEveryText: "Wird verlÃ¤ngert",
		renewsAutomaticallyText: "Wird vom VerkÃ¤ufer automatisch verlÃ¤ngert",
	...
	es: {
		...
		couponLabelText: "Introducir CÃ³digo promocional",
		couponPlaceholderText: "CÃ³digo promocional",
		crossSellText: "AÃ±adir al carrito",
		crossSellTitleText: "Usted tambiÃ©n podrÃ­a estar interesado en...",
		dayText: "dÃ­a",
		daysText: "dÃ­as",
		edsText: "AÃ±adir al carrito",
		freeText: "Gratis",
		monthText: "mes",
		monthsText: "meses",
		nextChargeText: "Siguiente cargo:",
		onText: "el",
		orderEmptyText: "Su pedido estÃ¡ vacÃ­o",
		orderTotalText: "Total",
		removeText: "Eliminar",
		renewsEveryText: "renueva cada ",
		renewsAutomaticallyText: "Renueva automÃ¡ticamente por el vendedor",
		renewsAlongWithSubscriptionText: "Renovaciones con la suscripciÃ³n",
		shippingText: "EnvÃ­o",
		...
		applyCouponText: "Ota kÃ¤yttÃ¶Ã¶n",
		cartTitleText: "OstoskÃ¤rry",
		...
		crossSellText: "LisÃ¤Ã¤ ostoskoriin",
		crossSellTitleText: "Saatat myÃ¶s olla kiinnostunut ...",
		dayText: "pÃ¤ivÃ¤",
		daysText: "pÃ¤ivÃ¤Ã¤",
		edsText: "LisÃ¤Ã¤ ostoskoriin",
		freeText: "Ilmainen",
		monthText: "kuukausi",
		monthsText: "kuukautta",
		nextChargeText: "Seuraava maksu:",
		onText: "pÃ¤ivÃ¤mÃ¤Ã¤rÃ¤nÃ¤",
		orderEmptyText: "Tilauksesi on tyhjÃ¤",
		orderTotalText: "Loppusumma",
		removeText: "Poista",
		renewsEveryText: "Uusiutuu joka ",
		renewsAutomaticallyText: "MyyjÃ¤ uusii tilauksen automaattisesti",
		renewsAlongWithSubscriptionText: "Uusiutuu tilauksen ohella",
		shippingText: "Laivaus",
		upSellText: "PÃ¤ivitys",
		viewDetailsText: "NÃ¤ytÃ¤ tiedot",
		volumeDiscountsAvailableText: "K\u00e4ytett\u00e4viss\u00e4 olevat paljousalennukset",
		weekText: "viikko",
		weeksText: "viikkoa",
		yearText: "vuosi",
		yearsText: "vuotta",
		youSaveText: "SÃ¤Ã¤stÃ¤t"
	},
	fr: {
		...
		crossSellTitleText: "Vous pourriez Ã©galement Ãªtre intÃ©ressÃ© par ...",
		dayText: "jour",
		daysText: "jours",
		...
		upSellText: "AmÃ©liorer",
		viewDetailsText: "Voir les dÃ©tails",
		volumeDiscountsAvailableText: "Remises sur gros volume disponibles",
		weekText: "semaine",
		weeksText: "semaines",
		yearText: "annÃ©es",
		yearsText: "annÃ©es",
		youSaveText: "Vous Ã©conomisez"
	},
	hr: {
		applyCouponText: "Primjeni postavke",
		cartTitleText: "KoÅ¡arica",
		...
		crossSellText: "Dodaj u koÅ¡aricu",
		crossSellTitleText: "MoÅ¾da Ä‡e vas zanimati i ...",
		dayText: "dan",
		daysText: "dana",
		edsText: "Dodaj u koÅ¡aricu",
		freeText: "Besplatno",
		monthText: "mjesec",
		monthsText: "mjeseÄno",
		nextChargeText: "SlijedeÄ‡a naplata:",
		onText: "UkljuÄeno",
		orderEmptyText: "VaÅ¡a NarudÅ¾ba je Prazna",
	...
	it: {
		...
		onText: "il",
		orderEmptyText: "Il tuo ordine Ã¨ vuoto",
	...
	ja: {
		applyCouponText: "é©ç”¨",
		cartTitleText: "ã‚·ãƒ§ãƒƒãƒ”ãƒ³ã‚°ã‚«ãƒ¼ãƒˆ",
		checkoutText: "ãƒã‚§ãƒƒã‚¯ã‚¢ã‚¦ãƒˆ",
		continueShoppingText: "ã‚·ãƒ§ãƒƒãƒ”ãƒ³ã‚°ã‚’ç¶šã‘ã‚‹",
		couponLabelText: "ãƒ—ãƒ­ãƒ¢ãƒ¼ã‚·ãƒ§ãƒ³ ã‚³ãƒ¼ãƒ‰ã‚’å…¥åŠ›",
		couponPlaceholderText: "ãƒ—ãƒ­ãƒ¢ãƒ¼ã‚·ãƒ§ãƒ³ ã‚³ãƒ¼ãƒ‰",
		crossSellText: "ã‚«ãƒ¼ãƒˆã«è¿½åŠ ",
		crossSellTitleText: "ã¾ãŸèˆˆå‘³ãŒã‚ã‚‹ã‹ã‚‚ã—ã‚Œã¾ã›ã‚“...",
		dayText: "æ—¥",
		daysText: "æ—¥",
		edsText: "ã‚«ãƒ¼ãƒˆã«è¿½åŠ ",
		freeText: "ç„¡æ–™",
		monthText: "æœˆ",
		monthsText: "æœˆ",
		nextChargeText: "æ¬¡å›žã®èª²é‡‘:",
		onText: "ã§",
		orderEmptyText: "æ³¨æ–‡ãŒç©ºã§ã™",
		orderTotalText: "åˆè¨ˆ",
		removeText: "å‰Šé™¤",
		renewsEveryText: "ã™ã¹ã¦æ›´æ–° ",
		renewsAutomaticallyText: "è²©å£²è€…ã«ã‚ˆã£ã¦è‡ªå‹•çš„ã«æ›´æ–°ã—ã¾ã™ã€‚",
		renewsAlongWithSubscriptionText: "ã‚µãƒ–ã‚¹ã‚¯ãƒªãƒ—ã‚·ãƒ§ãƒ³ã«å¾“ã„æ›´æ–°ã—ã¾ã™",
		shippingText: "é‹é€",
		upSellText: "ã‚¢ãƒƒãƒ—ã‚°ãƒ¬ãƒ¼ãƒ‰",
		viewDetailsText: "è©³ç´°ã‚’é–²è¦§",
		volumeDiscountsAvailableText: "æ•°é‡å‰²å¼•",
		weekText: "é€±",
		weeksText: "é€±",
		yearText: "å¹´",
		yearsText: "å¹´",
	...
	ko: {
		applyCouponText: "ì ìš©í•˜ê¸°",
		cartTitleText: "ì‡¼í•‘ ì¹´íŠ¸",
		checkoutText: "ì ê²€",
		continueShoppingText: "ì‡¼í•‘ì„ ê³„ì†",
		couponLabelText: "í”„ë¡œëª¨ì…˜ ì½”ë“œ ìž…ë ¥í•˜ê¸°",
		couponPlaceholderText: "ì¿ í° ì½”ë“œ",
		crossSellText: "ìž¥ë°”êµ¬ë‹ˆì— ë‹´ê¸°",
		crossSellTitleText: "ë‹¹ì‹ ì€ ë˜í•œ ê´€ì‹¬ì´ìžˆì„ ìˆ˜ ìžˆìŠµë‹ˆë‹¤ ...",
		dayText: "ì¼",
		daysText: "ì¼",
		edsText: "ìž¥ë°”êµ¬ë‹ˆì— ë‹´ê¸°",
		freeText: "ë¬´ë£Œ",
		monthText: "ê°œì›”",
		monthsText: "ê°œì›”",
		nextChargeText: "ë‹¤ìŒ ì²­êµ¬:",
		onText: "~ì—",
		orderEmptyText: "ì£¼ë¬¸ì´ ë¹„ì–´ ìžˆìŠµë‹ˆë‹¤",
		orderTotalText: "í•©ê³„",
		removeText: "ì œê±°í•˜ê¸°",
		renewsEveryText: " ë§ˆë‹¤ ê°±ì‹ ",
		renewsAutomaticallyText: "íŒë§¤ìžê°€ ìžë™ìœ¼ë¡œ ê°±ì‹ ",
		renewsAlongWithSubscriptionText: "êµ¬ë…ê³¼ í•¨ê»˜ ê°±ì‹ ",
		shippingText: "ë°°ì†¡",
		upSellText: "ì—…ê·¸ë ˆì´ë“œ",
		viewDetailsText: "ì„¸ë¶€ ì •ë³´ ë³´ê¸°",
		volumeDiscountsAvailableText: "ëŒ€ëŸ‰ êµ¬ë§¤ í• ì¸ ê°€ëŠ¥",
		weekText: "ì£¼",
		weeksText: "ì£¼",
		yearText: "ë…„",
		yearsText: "ë…„",
		youSaveText: "~ì„ ì ˆì•½í•©ë‹ˆë‹¤"
	},
	nl: {
		...
		crossSellTitleText:"Misschien ben je ook geÃ¯nteresseerd in ...",
		dayText:"dagen",
		daysText:"dagen",
	...
	pt: {
		...
		checkoutText: "VerificaÃ§Ã£o de saÃ­da",
		continueShoppingText: "Continue comprando",
		couponLabelText: "Inserir cÃ³digo do cupÃ£o",
		couponPlaceholderText: "CÃ³digo do cupÃ£o",
		crossSellText: "Adicionar ao carrinho",
		crossSellTitleText: "Talvez vocÃª tambÃ©m esteja interessado em ...",
		dayText: "dia",
		daysText: "dias",
		...
		monthText: "mÃªs",
		monthsText: "meses",
		nextChargeText: "PrÃ³xima cobranÃ§a:",
		onText: "em",
		orderEmptyText: "O Seu Pedido EstÃ¡ Vazio",
		orderTotalText: "Total",
		removeText: "Remover",
		renewsEveryText: "Renova todas ",
		renewsAutomaticallyText: "RenovaÃ§Ã£o automÃ¡tica pelo vendedor",
		renewsAlongWithSubscriptionText: "Renova em conjunto com a subscriÃ§Ã£o",
	...
	ru: {
		applyCouponText: "ÐŸÑ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ",
		cartTitleText: "ÐšÐ¾Ñ€Ð·Ð¸Ð½Ð°",
		checkoutText: "ÐºÐ¾Ð½Ñ‚Ñ€Ð¾Ð»ÑŒ",
		continueShoppingText: "ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¸",
		couponLabelText: "Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÐºÐ¾Ð´ ÐºÑƒÐ¿Ð¾Ð½Ð°",
		couponPlaceholderText: "ÐšÐ¾Ð´ ÐºÑƒÐ¿Ð¾Ð½Ð°",
		crossSellText: "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð² ÐºÐ¾Ñ€Ð·Ð¸Ð½Ñƒ",
		crossSellTitleText: "Ð’Ñ‹ Ñ‚Ð°ÐºÐ¶Ðµ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð±Ñ‹Ñ‚ÑŒ Ð·Ð°Ð¸Ð½Ñ‚ÐµÑ€ÐµÑÐ¾Ð²Ð°Ð½Ñ‹ Ð² ...",
		dayText: "Ð´ÐµÐ½ÑŒ",
		daysText: "Ð´Ð½ÐµÐ¹",
		edsText: "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð² ÐºÐ¾Ñ€Ð·Ð¸Ð½Ñƒ",
		freeText: "Ð‘ÐµÑÐ¿Ð»Ð°Ñ‚Ð½Ð¾",
		monthText: "Ð¼ÐµÑÑÑ†",
		monthsText: "Ð¼ÐµÑÑÑ†ÐµÐ²",
		nextChargeText: "Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð°Ñ Ð¾Ð¿Ð»Ð°Ñ‚Ð°:",
		onText: "Ð½Ð°",
		orderEmptyText: "Ð’Ð°Ñˆ Ð·Ð°ÐºÐ°Ð· Ð¿ÑƒÑÑ‚",
		orderTotalText: "Ð’ÑÐµÐ³Ð¾",
		removeText: "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ",
		renewsEveryText: "Ð’Ð¾Ð·Ð¾Ð±Ð½Ð¾Ð²Ð»ÑÐµÑ‚ÑÑ ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ",
		renewsAutomaticallyText: "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸ Ð²Ð¾Ð·Ð¾Ð±Ð½Ð¾Ð²Ð»ÑÐµÑ‚ÑÑ Ð¿Ñ€Ð¾Ð´Ð°Ð²Ñ†Ð¾Ð¼",
		renewsAlongWithSubscriptionText: "ÐžÐ±Ð½Ð¾Ð²Ð»ÑÐµÑ‚ÑÑ Ð²Ð¼ÐµÑÑ‚Ðµ Ñ Ð¿Ð¾Ð´Ð¿Ð¸ÑÐºÐ¾Ð¹",
		shippingText: "ÐŸÐµÑ€ÐµÐ²Ð¾Ð·ÐºÐ°",
		upSellText: "ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ",
		viewDetailsText: "ÐŸÐ¾ÑÐ¼Ð¾Ñ‚Ñ€ÐµÑ‚ÑŒ Ð´ÐµÑ‚Ð°Ð»Ð¸",
		volumeDiscountsAvailableText: "ÐžÐ±ÑŠÐµÐ¼ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… ÑÐºÐ¸Ð´Ð¾Ðº",
		weekText: "Ð½ÐµÐ´ÐµÐ»ÑŽ",
		weeksText: "Ð½ÐµÐ´ÐµÐ»ÑŒ",
		yearText: "Ð³Ð¾Ð´",
		yearsText: "Ð»ÐµÑ‚",
		youSaveText: "Ð’Ñ‹ ÑÐºÐ¾Ð½Ð¾Ð¼Ð¸Ñ‚Ðµ"
	},
	sv: {
		applyCouponText: "AnvÃ¤nd",
		cartTitleText: "Kundvagn",
		checkoutText: "Kassa",
		continueShoppingText: "FortsÃ¤tt handla",
		couponLabelText: "Ange rabattkod",
		couponPlaceholderText: "Rabattkod",
		crossSellText: "LÃ¤gg till i kundvagn",
		crossSellTitleText: "Du kanske ocksÃ¥ Ã¤r intresserad av ...",
		dayText: "dag",
		daysText: "dagar",
		edsText: "LÃ¤gg till i kundvagn",
		freeText: "Gratis",
		monthText: "mÃ¥nad",
		monthsText: "mÃ¥nader",
		nextChargeText: "NÃ¤sta debitering:",
		onText: "pÃ¥",
		orderEmptyText: "Din bestÃ¤llning innehÃ¥ller inget",
		orderTotalText: "Totalsumma",
		removeText: "Ta bort",
		renewsEveryText: "FÃ¶rnyas varje ",
		renewsAutomaticallyText: "FÃ¶rnyas automatiskt av sÃ¤ljaren",
		renewsAlongWithSubscriptionText: "FÃ¶rnyas tillsammans med prenumeration",
		shippingText: "Frakt",
	...
	zh: {
		applyCouponText: "åº”ç”¨",
		cartTitleText: "è´­ç‰©è½¦",
		checkoutText: "æŸ¥çœ‹",
		continueShoppingText: "ç»§ç»­è´­ç‰©",
		couponLabelText: "è¾“å…¥ä¼˜æƒ ç ",
		couponPlaceholderText: "ä¼˜æƒ ç ",
		crossSellText: "æ·»åŠ åˆ°è´­ç‰©è½¦",
		crossSellTitleText: "æ‚¨ä¹Ÿå¯èƒ½å¯¹ã€‚ã€‚ã€‚æœ‰å…´è¶£...",
		dayText: "å¤©",
		daysText: "å¤©",
		edsText: "æ·»åŠ åˆ°è´­ç‰©è½¦",
		freeText: "å…è´¹",
		monthText: "æœˆ",
		monthsText: "æœˆ",
		nextChargeText: "ä¸‹ä¸€ä¸ªæ”¶è´¹ï¼š",
		onText: "å¼€",
		orderEmptyText: "æ‚¨çš„è®¢å•æ˜¯ç©ºçš„",
		orderTotalText: "æ€»è®¡",
		removeText: "ç§»é™¤",
		renewsEveryText: "æ¯ æ›´æ–°",
		renewsAutomaticallyText: "å–å®¶è¿›è¡Œè‡ªåŠ¨æ›´æ–°",
		renewsAlongWithSubscriptionText: "éšè®¢é˜…è¿›è¡Œæ›´æ–°",
		shippingText: "è¿è¾“",
		upSellText: "å‡çº§",
		viewDetailsText: "æŸ¥çœ‹è¯¦æƒ…",
		volumeDiscountsAvailableText: "æ‰¹é‡æŠ˜æ‰£å¯ç”¨",
		weekText: "å‘¨",
		weeksText: "å‘¨",
		yearText: "å¹´",
		yearsText: "å¹´",
